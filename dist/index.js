        ...
        try {
            ...
            if (!parsedBump) {
                if (isPrerelease !== 'true' && !releaseVersion) {
                    ...
                    core.warning(`[warm] can not parse nextBump from release_verison: ${releaseVersion}`);
                }
            }
            else {
            ...
            if (needWrite === 'true' && parsedBump) {
                ...
                if (parsedBump !== nextBump) {
                    (0, read_policies_1.writeNextBump)(parsedBump, rushPath, policyName);
                }
            }
...
const writeJsonFile = (path, filename, 
...
const readBumpType = (rushPath = './', policyName) => {
    var _a;
    const versionPoliciesJson = (0, exports.findJsonFile)(rushPath, 'common/config/rush/version-policies.json');
    ...
    if (policyName) {
        const item = versionPoliciesJson === null || versionPoliciesJson === void 0 ? void 0 : versionPoliciesJson.find(entry => entry.policyName === policyName);
        return item === null || item === void 0 ? void 0 : item.nextBump;
    }
    else {
        return (_a = versionPoliciesJson === null || versionPoliciesJson === void 0 ? void 0 : versionPoliciesJson[0]) === null || _a === void 0 ? void 0 : _a.nextBump;
    }
};
exports.readBumpType = readBumpType;
const parseNextBumpFromVersion = (versionString) => {
    const parsed = (0, semver_1.parse)(versionString);
    if (!parsed) {
        return;
    }
...
exports.parseNextBumpFromVersion = parseNextBumpFromVersion;
const writeNextBump = (nextBump, rushPath = './', policyName) => {
    ...
    if (policyName) {
        ...
        if (item) {
            ...
            (0, exports.writeJsonFile)(rushPath, versionPoliciesPath, versionPoliciesJson);
        }
        else if (versionPoliciesJson === null || versionPoliciesJson === void 0 ? void 0 : versionPoliciesJson.length) {
